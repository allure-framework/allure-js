...
class AllureTest extends ExecutableItemWrapper_1.ExecutableItemWrapper {
  ...
  calculateHistoryId() {
    ...
    const paramsString = this.testResult.parameters
      ...
      .sort((a, b) => {
        var _a, _b;
        return (
          ((_a = a.name) === null || _a === void 0
            ? void 0
            : _a.localeCompare(b === null || b === void 0 ? void 0 : b.name)) ||
          ((_b = a.value) === null || _b === void 0
            ? void 0
            : _b.localeCompare(b === null || b === void 0 ? void 0 : b.value))
        );
      })
      .map((p) => {
        var _a, _b;
        return `${(_a = p.name) !== null && _a !== void 0 ? _a : "null"}:${
          (_b = p.value) !== null && _b !== void 0 ? _b : "null"
        }`;
      })
      .join(",");
  ...
  applyMetadata(metadata, stepApplyFn) {
    ...
    steps.forEach((stepMetadata) => {
      const step = AllureCommandStep_1.AllureCommandStepExecutable.toExecutableItem(
        this.runtime,
        stepMetadata,
      );
      if (stepApplyFn) {
