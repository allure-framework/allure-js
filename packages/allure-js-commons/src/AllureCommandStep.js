...
class AllureCommandStepExecutable {
  ...
  static toExecutableItem(runtime, stepMetadata) {
    const executable = Object.assign(Object.assign({}, stepMetadata), {
      attachments: [],
      steps: [],
    });
  ...
  async run(body, messageEmitter) {
    ...
    try {
      ...
      const _a = this.metadata,
        { steps = [], description = "", descriptionHtml = "" } = _a,
        metadata = __rest(_a, ["steps", "description", "descriptionHtml"]);
      ...
      const _b = this.metadata,
        { steps = [], description = "", descriptionHtml = "" } = _b,
        metadata = __rest(_b, ["steps", "description", "descriptionHtml"]);
      await messageEmitter(
        Object.assign(Object.assign({}, metadata), {
          steps: [
            {
